...
/*
We define the function make_daytime_string() to create the string to be sent back to the client. This function will be reused in all of the daytime server tutorials.
*/
...
int main()
{
    try
    {
        ...
        /*
        A ip::tcp::acceptor object needs to be created to listen for new connections. It is initialised on a TCP port 13, for IP version 4.
        */
