...
/*
We will use shared_ptr and enable_shared_from_this because we want tp keep the tcp_connection object alive as long as there is an operation that refers to it.
*/
...
private:
    ...
    */
    ...
    /*
    The function handle_accept() is called when the asynchronous accept operation inititiated by start_accept() finishes. It services the client request, and then calls start_accept() to initiate the next accept operation.
    */
...
int main()
{
    try
    {
        ...
        */
        ...
        /* 
        Run the boost::asio::io_service object so that it will perform operations on your behalf. 
        */
        io_context.run();
    }
